defmodule Jxon do
  ...
  def parse(json, handler, start_index, acc) do
    ...
    <<_skip::binary-size(start_index), the_rest::bits>> = json
    parse(the_rest, the_rest, handler, start_index, acc)
  end
  ...
  # TODO: implement good string escaping here.
